...
const nameBand = 'CLINT MANSELL';

let nameSongs = [
	"REQUIEM FOR A DREAM", /*1*/
	"SUMMER OVERTURE", /*2*/
	"PARTY", /*3*/
	"CONEY ISLAND DREAMING", /*4*/
	"CHOCOLATE CHARMS", /*5*/
	"GHOSTS OF THINGS TO COME", /*6*/
	"TENSE", /*7*/
	"DR. PILL", /*8*/
	"GHOSTS", /*9*/
	"CRIMIN' & DEALIN'", /*10*/
	"HOPE OVERTURE", /*11*/
	"CLEANING APARTMENT", /*12*/
	"ARNOLD", /*13*/
	"MARION BARFS", /*14*/
	"SUPERMARKET SWEEP", /*15*/
	"SHE  HAS LEFT THE BUILDING", /*16*/
	"SOUTHERN HOSPITALITY", /*17*/
	"FEAR", /*18*/
	"THE BEGINNING OF THE END", /*19*/
	"CONEY ISLAND LOW", /*20*/
]
