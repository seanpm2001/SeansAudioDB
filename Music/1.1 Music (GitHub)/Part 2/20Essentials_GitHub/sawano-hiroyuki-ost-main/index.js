...
const nameBand = 'SAWANO HIROYUKI';
...
let nameSongs = [
	...
	"ERENTHE標", /*8*/
	"2VOLT", /*9*/
	"進撃st-hrn-egt20130629巨人", /*10*/
	"進撃vc-pf20130218巨人", /*11*/
	"ATTACK音D", /*12*/
	"CÓUNTER・ATTÀCK-M ÆNKΆꞮND", /*13*/
	"E・M・A", /*14*/
	"立BODY機MOTION", /*15*/
	"THE RELUCTANT HEROES", /*16*/
	"CALL YOUR NAME", /*17*/
	"CALL OF SILENCE ", /*18*/
	"ZERO ECLIPSE", /*19*/
	"K21", /*20*/
...
(function headerSAWANProperties() {
  const { body } = document;
