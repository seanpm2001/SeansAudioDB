/* =======================SET======================= */
const nameBand = "THE KNACK";

let nameSongs = [
  "MY SHARONA" /*1*/,
  "GOOD GIRLS DON'T" /*2*/,
  "BABY TALKS DIRTY" /*3*/,
  "CAN'T PUT A PRICE ON LOVE" /*4*/,
  "PAY THE DEVIL" /*5*/,
  "FRUSTRATED" /*6*/,
  "THE FEELING I GET" /*7*/,
  ...
  "SHE'S SO SELFISH" /*9*/,
  "ROCKET O' LOVE" /*10*/,
  "JUST WAIT AND SEE" /*11*/,
  "THAT'S WHAT THE LITTLE GIRLS DO" /*12*/,
  "YOUR NUMBER OR YOUR NAME" /*13*/,
  "LET ME OUT" /*14*/,
  "(HAVIN' A) RAVE UP" /*15*/,
  "END OF THE GAME" /*16*/,
  "LES GIRLS" /*17*/,
  "CAN I BORROW A KISS" /*18*/,
  "AFRICA" /*19*/,
  "SERIOUS FUN" /*20*/,
];
