...
const nameBand = 'LUIS ENRIQUE';

let nameSongs = [
	"YO NO SÉ MAÑANA", /*1*/
	"TÚ NO LE AMAS LE TEMES", /*2*/
	"LO QUE PASÓ ENTRE TÚ Y YO PASÓ", /*3*/
	"MI MUNDO", /*4*/
	"DESESPERADO", /*5*/
	"DATE UN CHANCE", /*6*/
	"AUTOBIOGRAFÍA ", /*7*/
	...
	"Y PENSAR", /*10*/
	"COMPRÉNDELO", /*11*/
	"YO NO PUEDO SER TU AMANTE", /*12*/
	"ASÍ ES LA VIDA", /*13*/
	"BESAR TU BOCA", /*14*/
	"SOMBRAS NADA MÁS", /*15*/
	"NO TE QUITES LA ROPA", /*16*/
	"EL AMOR ES ALGO MÁS", /*17*/
	"DILEMA", /*18*/
	"DE CORAZÓN A CORAZÓN", /*19*/
	"PEQUEÑA", /*20*/
]
