...
const nameBand = 'THE KILLERS';

let nameSongs = [
	"SHADOWPLAY", /*1*/
	"SHOT AT THE NIGHT", /*2*/
	"MR. BRIGHTSIDE", /*3*/
	"EVERTYTHING WILL BE ALRIGHT", /*4*/
	"HUMAN", /*5*/
	"SMILE LIKE YOU MEAN IT", /*6*/
	"JENNY WAS A FRIEND", /*7*/
	"ON TOP", /*8*/
	"MIDNIGHT SHOW", /*9*/
	"SOMEBODY TOLD ME", /*10*/
	"BELIEVE ME NATALIE", /*11*/
	"ANDY YOU’RE STAR", /*12*/
	"CHANGE YOUR MIND", /*13*/
	"GLAMOROUS INDIE ROCK & ROLL", /*14*/
	"WHEN YOU WERE YOUNG", /*15*/
	"ALL THESE THINGS THAT I'VE DONE", /*16*/
	"SPACEMAN", /*17*/
	"MISS ATOMIC BOMB", /*18*/
	"HERE WITH ME", /*19*/
	"BATTLE BORN", /*20*/
