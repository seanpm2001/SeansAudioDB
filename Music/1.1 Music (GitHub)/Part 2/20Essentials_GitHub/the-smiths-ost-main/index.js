...
const nameBand = 'THE SMITHS';

let nameSongs = [
	"THIS CHARMING MAN", /*1*/
	"SOME GIRLS ARE BIGGER THAN OTHERS", /*2*/
	"BARBARISM BEGINS AT HOME", /*3*/
	"THE HEADMASTER RITUAL", /*4*/
	"THAT JOKE ISN'T FUNNY ANYMORE", /*5*/
	"WELL I WONDER", /*6*/
	"HOW SOON IS NOW?", /*7*/
	"HEAVEN KNOWS I'M MISERABLE NOW", /*8*/
	"THIS NIGHT HAS OPENED MY EYES", /*9*/
	"BACK TO THE OLD HOUSE", /*10*/
	"LAST NIGHT I DREAMT THAT SOMEBODY LOVED ME", /*11*/
	"PAINT A VULGAR PICTURE", /*12*/
	"DEATH OF A DISCO DANCER", /*13*/
	"THE QUEEN IS DEAD", /*14*/
	"I KNOW IT'S OVER", /*15*/
	"NEVER HAD NO ONE EVER", /*16*/
	"I STARTED SOMETHING I COULDN'T FINISH", /*17*/
	"SUFFER LITTLE CHILDREN", /*18*/
	"THE HAND THAT ROCKS THE CRADLE", /*19*/
	"REEL AROUND THE FOUNTAIN", /*20*/
];
