...
let nameSongs = [
	...
	"YO ME IRE", /*3*/
	"ESE HOMBRE SOY YO", /*4*/
	"BUSCO UN CONFIDENTE", /*5*/
	"DE MADRUGADA", /*6*/
	"PERDONAME", /*7*/
	"QUITAME LA VIDA", /*8*/
	"SUBLIME MUJER", /*9*/
	"CORAZÓN DURO", /*10*/
	"CON EL ALMA DESNUDA", /*11*/
	"AMOR DE POBRE", /*12*/
	"DESPERTE LLAMANDOTE", /*13*/
	"LA DISTANCIA", /*14*/
	"QUIEN TE RIZA EL PELO", /*15*/
	"SI TI NO SOY NADA", /*16*/
	"QUÉ CARA MÁS BONITA", /*17*/
	"A DONDE VAYAS", /*18*/
	"ESA MUJER", /*19*/
	"CORAZÓN DE MADERA", /*20*/
]
