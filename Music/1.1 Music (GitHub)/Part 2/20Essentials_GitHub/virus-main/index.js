...
const nameBand = "VIRUS";

const nameSongs = [
	"PRONTA ENTREGA", /*1*/
	"LUNA DE MIEL EN LA MANO", /*2*/
	"IMÁGENES PAGANAS", /*3*/
	"AMOR DESCARTABLE", /*4*/
	"SIN DISFRAZ", /*5*/
	"WADU WADU", /*6*/
	"TOMO LO QUE ENCUENTRO", /*7*/
	"DAME UNA SEÑAL", /*8*/
	"ENCUENTRO EN EL RÍO", /*9*/
	"ME PUEDO PROGRAMAR", /*10*/
	"DESTINO CIRCULAR", /*11*/
	"MIRADA SPEED", /*12*/
	"PECADO PARA DOS", /*13*/
	"DICHA FELIZ ", /*14*/
	"POLVOS DE UNA RELACIÓN", /*15*/
	"HAY QUE SALIR DEL AGUJERO INTERIOR", /*16*/
	"EL ROCK ES MI FORMA DE SER", /*17*/
	"DESESPERADO SECUENCIA UNO", /*18*/
	"QUÉ HAGO EN MANILA?", /*19*/
	"JUEGOS INCOMPLETOS", /*20*/
]
