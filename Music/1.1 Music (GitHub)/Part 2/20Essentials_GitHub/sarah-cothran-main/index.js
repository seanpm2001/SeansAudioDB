...
const nameBand = 'SARAH COTHRAN';

const nameSongs = [
	"AS THE WORLD X DRIVER'S LICENSE", /*1*/
	"LOVE STORY", /*2*/
	"BURNING PILE - MOTHER MOTHER", /*3*/
	"SWEET BUT PSYCHO", /*4*/
	"AS THE WORLD CAVES IN", /*5*/
	"BABY WHY", /*6*/
	"DON’T WANT MY HEART", /*7*/
	"I'M HERE", /*8*/
	"POOR MARIONETTE", /*9*/
	"STRONGER THAN ME", /*10*/
	"TALKING TO MYSELF", /*11*/
	"ZOMBIE - THE CRANBERRIES", /*12*/
	"NO TIME TO DIE", /*13*/
	"SUMMERTIME SADNESS - LANA DEL REY", /*14*/
	"VIVA LA VIDA - COLDPLAY", /*15*/
	"FUNERAL", /*16*/
