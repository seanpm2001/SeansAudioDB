...
const nameBand = 'LA INDIA';

const nameSongs = [
	"MI MAYOR VENGANZA", /*1*/
	"ESE HOMBRE", /*2*/
	"VIVIR LO NUESTRO", /*3*/
	"QUE GANAS DE NO VERTE NUNCA MÁS", /*4*/
	"ME CANSÉ DE SER LA OTRA", /*5*/
	"DICEN QUE SOY", /*6*/
	"YO NO VUELVO A MOLESTARTE", /*7*/
	"ESTUPIDA", /*8*/
	"NUNCA VOY A OLVIDARTE", /*9*/
	"COSTUMBRES", /*10*/
	"TU AMOR ES MI PIEL", /*11*/
	"MALDITO Y BENDITO AMOR", /*12*/
	"NO ME CONVIENE", /*13*/
	"O ELLA O YO", /*14*/
	"MI ALMA", /*15*/
	"MI PRIMERA RUMBA", /*16*/
	"SOLA", /*17*/
	"DEJATE AMAR", /*18*/
	"EL HOMBRE PERFECTO", /*19*/
	"SI ESTUVIERAS AQUÍ", /*20*/
]
