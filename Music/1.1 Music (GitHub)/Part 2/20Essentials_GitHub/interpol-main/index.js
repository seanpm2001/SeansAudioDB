...
const nameBand = 'INTERPOL ';

let nameSongs = [
	"EVIL", /*1*/
	"C'MERE", /*2*/
	"ALL THE RAGE BACK HOME", /*3*/
	"OBSTACLE 1", /*4*/
	"BARRICADE", /*5*/
	"ROLAND", /*6*/
	"PDA", /*7*/
	"LEIF ERIKSON", /*8*/
	"SAY HELLO TO THE ANGELS", /*9*/
	"THE NEW", /*10*/
	"NARC", /*11*/
	"SLOW HANDS", /*12*/
	"NO I IN THREESOME", /*13*/
	"REST MY CHEMISTRY", /*14*/
	"PIONEER TO THE FALLS", /*15*/
	"NOT EVEN JAIL", /*16*/
	"NYC", /*17*/
	"THE HEINRICH MANEUVER", /*18*/
	"TAKE YOU ON A CRUISE", /*19*/
	"MY DESIRE", /*20*/
]
