...
let nameSongs = [
	...
	"IN THE NAVY", /*3*/
	"GO WEST", /*4*/
	"CAN'T STOP THE MUSIC", /*5*/
	"SAN FRANCISCO (YOU'VE GOT ME)", /*6*/
	"JUST A GIGOLO ", /*7*/
	"I WANNA SHAKE YOUR HAND", /*8*/
	"CITIZENS OF THE WORLD", /*9*/
	"SUCCESS", /*10*/
	"SPACED OUT", /*11*/
	"IN THE STREET", /*12*/
	"GET AWAY HOLIDAY", /*13*/
	"JUST GIVE ME WHAT I WANT", /*14*/
	"POWER OF THE NIGHT", /*15*/
	"SEXUAL EDUCATION", /*16*/
	"FIREMAN", /*17*/
	"5’OCLOCK IN THE MORNING", /*18*/
	"DO YOU WANNA SPEND THE NIGHT?", /*19*/
	"FIRE ISLAND", /*20*/
]
