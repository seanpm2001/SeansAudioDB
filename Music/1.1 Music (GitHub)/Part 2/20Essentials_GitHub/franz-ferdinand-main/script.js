/* =======================SET======================= */
const nameBand = "FRANZ FERDINAND";

let nameSongs = [
	"TAKE ME OUT", /*1*/
	"THIS FIRE", /*2*/
	"THE DARK OF THE MATINÉE", /*3*/
	"DO YOU WANT TO", /*4*/
	"NO YOU GIRLS", /*5*/
	"LOVE ILLUMINATION", /*6*/
	"STAND ON THE HORIZON", /*7*/
	"ALWAYS ASCENDING", /*8*/
	"GLIMPSE OF LOVE", /*9*/
	"WALK AWAY", /*10*/
	"DARTS OF PLEASURE", /*11*/
	"ULYSSES", /*12*/
	"JEREMY FRASER", /*13*/
	"WINE IN THE AFTERNOON", /*14*/
	"ELEANOR PUT YOUR BOOTS ON", /*15*/
	"L. WELLS", /*16*/
	"FRESH STRAWBERRIES", /*17*/
	"FEEL THE LOVE GO", /*18*/
	"CAN'T STOP FEELING", /*19*/
	"RIGHT ACTION", /*20*/
]
