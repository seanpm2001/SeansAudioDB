/* =======================SET======================= */
const nameBand = "TERRENCE MANN";

let nameSongs = [
	"POWER OF THE NIGHT", /*1*/
	"THE BALLAD OF SWEENEY TODD ", /*2*/
	"ONE DAY MORE", /*3*/
	"STARS", /*4*/
	"BRING HIM HOME", /*5*/
	...
	"LOOK DOWN", /*7*/
	"ABC CAFÉ", /*8*/
	"THE RUM TUM TUGGER", /*9*/
	" THE THEATRE CAT", /*10*/
	"THE PHANTOM OF THE OPERA", /*11*/
	"THE MUSIC OF THE NIGHT", /*12*/
	"THE HEAT IS ON IN SAIGON", /*13*/
	"AMERICAN DREAM", /*14*/
	"THE MORNING OF THE DRAGON", /*15*/
	"CIRCUS OF YOUR MIND", /*16*/
	"PLAY", /*17*/
	"LIVE BY THE HOOK", /*18*/
	"ALL OF LONDON IS HERE TONIGHT", /*19*/
	"KIM'S NIGHTMARE", /*20*/
]
