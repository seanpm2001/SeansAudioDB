...
const nameBand = "BARBIE - SOUNDTRACK";

const nameSongs = [
	"AHORA SOY (VERSIÓN KEIRA)", /*1*/
	"I NEED TO KNOW", /*2*/
	"VA A SER MARAVILLOSO", /*3*/
	"QUEEN OF THE WAVES", /*4*/
	"AHORA SOY (VERSIÓN TORI Y KEIRA)", /*5*/
	"ON TOP OF THE WORLD", /*6*/
	"DEBO SABER", /*7*/
	"WRAP IT UP, STACK IT UP", /*8*/
	"IT'S GONNA BE AMAZING", /*9*/
	"HERE I AM (KERIA VERSION)", /*10*/
	"I'VE GOT MAGIC", /*11*/
	"PRINCESSES JUST WANT TO HAVE FUN", /*12*/
	"I WANT IT ALL", /*13*/
	"TO BE A PRINCESS / TO BE A POPSTAR", /*14*/
	"PRINCESS & THE POPSTAR", /*15*/
	"CONFÍO", /*16*/
	"NUESTRO VUELO ALZAR", /*17*/
	"ESTE SENTIR NO TIENE FIN", /*18*/
	"UNA ESTRELLA SOY", /*19*/
	"SHOW FINAL", /*20*/
]
