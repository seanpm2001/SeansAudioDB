/* =======================SET======================= */
const nameBand = "URGE OVERKILL";

let nameSongs = [
	"SISTER HAVANA", /*1*/
	"GIRL, YOU'LL BE A WOMAN SOON", /*2*/
	"POSITIVE BLEEDING", /*3*/
	"TEQUILA SUNRISE", /*4*/
	"SATURATION", /*5*/
	"STULL (PART 1)", /*6*/
	...
	"THE STALKER", /*8*/
	"GOD FLINSTONE", /*9*/
	"YOUR FRIEND IS INSANE", /*10*/
	"EFFIGY", /*11*/
	"QUIET PERSON", /*12*/
	"ROCK & ROLL SUBMARINE", /*13*/
	"ERICA KANE", /*14*/
	"HOW SWEET THE LIGHT", /*15*/
	"SNOW", /*16*/
	"FOLLOW MY SHADOW", /*17*/
	"FORGIVEN", /*18*/
	"I CAN'T STAY GLAD@U", /*19*/
	"A PRISONER'S DILEMMA", /*20*/
]
