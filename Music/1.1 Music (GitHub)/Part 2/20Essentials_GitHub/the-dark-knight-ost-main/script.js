/* =======================SET======================= */
const nameBand = "THE DARK KNIGHT - OST";

let nameSongs = [
	"ANTROZOUS", /*1*/
	"MOLOSSUS ", /*2*/
	"A WATCHFUL GUARDIAN", /*3*/
	"I'M NOT A HERO", /*4*/
	"LIKE A DOG CHASING CARS", /*5*/
	"THE DARK KNIGHT MAIN THEME", /*6*/
	"MACROTUS ", /*7*/
	"RISE ", /*8*/
	"INTRODUCE A LITTLE ANARCHY ", /*9*/
	"AGENT OF CHAOS", /*10*/
	"RISEN FROM DARKNESS ", /*11*/
	"AGGRESSIVE EXPANSION ", /*12*/
	"END CREDITS", /*13*/
	"A DARK KNIGHT", /*14*/
	"NO STONE UNTURNED ", /*15*/
	"IMAGINE THE FIRE", /*16*/
	"THE FIRE RISES", /*17*/
	"GOTHAM'S RECKONING", /*18*/
	"MIND IF I CUT IN?", /*19*/
	"WHY SO SERIOUS?", /*20*/
]
