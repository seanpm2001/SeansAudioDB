...
const nameBand = 'BEN 10';

const nameSongs = [
	"END CREDITS (SEASON 1-3)", /*1*/
	"END CREDITS (SEASON 3-4)", /*2*/
	"AGAINST TIME", /*3*/
	"ALIEN FORCE | END CREDITS ", /*4*/
	"OMNIVERSE ENDING", /*5*/
	"ANIMO REANIMATING", /*6*/
	"DESTROY ALL ALIENS", /*7*/
	"ULTIMATE ALIEN | ENDING", /*8*/
	"OMNIV", /*9*/
	"GALACTIC MONSTERS", /*10*/
	"ALIEN FORCE CLOSING CREDITS", /*11*/
	"FIGHT FOR THE EGGS", /*12*/
	"AQUATIC BATTLE", /*13*/
	"LIMAX CHASE", /*14*/
	"WILDMUTT AND THE FAKE MAX", /*15*/
	"BEN AND KEVIN IN TROUBLE", /*16*/
	"IN THE SUBWAY STATION", /*17*/
	"CHASE THROUGH THE HOSPITAL", /*18*/
	"FLAMING ROCKS", /*19*/
	"UPGRADE CHASE", /*20*/
]
