/* =======================SET======================= */
const nameBand = "ROCIO JURADO";

let nameSongs = [
	"QUIÉN TE CREES TÚ", /*1*/
	"SEÑORA", /*2*/
	"TODO SE DERRUMBÓ DENTRO DE MÍ", /*3*/
	"COMO YO TE AMO", /*4*/
	"ALGO SE ME FUE CONTIGO", /*5*/
	"DÉJALA CORRER", /*6*/
	"¿DÓNDE ESTÁS AMOR?", /*7*/
	"NECESITO ESTAR SOLA", /*8*/
	"PUNTO DE PARTIDA", /*9*/
	"SE NOS ROMPIÓ EL AMOR", /*10*/
	"PUNTO DE PARTIDA", /*11*/
	"MUERA EL AMOR", /*12*/
	"AMOR DE NOCHE", /*13*/
	"¿POR QUÉ ME HABRÁS BESADO?", /*14*/
	"VIBRO", /*15*/
	"PALOMA BRAVA", /*16*/
	"ME HUBIERA GUSTADO TANTO", /*17*/
	"ESE HOMBRE", /*18*/
	"VIVA EL PASODOBLE", /*19*/
	"COMO LAS ALAS AL VIENTO", /*20*/
]
