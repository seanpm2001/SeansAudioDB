...
const nameSongs = [
	...
	"OOOPS UP", /*3*/
	"COLOUR OF LOVE", /*4*/
	"MARY HAD A LITTLE BOY", /*5*/
	"RAME", /*6*/
	"THE FIRST THE LAST ETERNITY", /*7*/
	"DO YOU SEE THE LIGHT", /*8*/
	"CULT OF SNAP", /*9*/
	"WELCOME TO TOMORROW", /*10*/
	"EXTERMINATE!", /*11*/
	"WORLD IN MY HANDS", /*12*/
	"BEAUTY QUEEN", /*13*/
	"THE POWER OF BHANGRA", /*14*/
	"BELIEVE IN IT", /*15*/
	"BELIEVE THE HYPE", /*16*/
	"THE POWER (7th VERSION)", /*17*/
	"WHO STOLE IT?", /*18*/
	"EX-TERMINATOR", /*19*/
	"THE FIRST THE LAST ETERNITY", /*20*/
]
