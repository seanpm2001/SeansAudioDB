/* =======================SET======================= */
const nameBand = "OUTLAWS ";

let nameSongs = [
	"GREEN GRASS AND HIGH TIDES", /*1*/
	"FREEBORN MAN", /*2*/
	"STICK AROUND FOR ROCK & ROLL", /*3*/
	"GHOST RIDERS IN THE SKY", /*4*/
	"HURRY SUNDOWN", /*5*/
	"THERE GOES ANOTHER LOVE SONG", /*6*/
	"SOUTHERN ROCK WILL NEVER DIE", /*7*/
	"SONG IN THE BREEZE", /*8*/
	"YOU ARE THE SHOW", /*9*/
	"HOLIDAY", /*10*/
	"SONG FOR YOU", /*11*/
	"ANGEL’S HIDE", /*12*/
