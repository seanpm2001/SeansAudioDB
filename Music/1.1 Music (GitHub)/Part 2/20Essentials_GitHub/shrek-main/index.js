...
const nameBand = 'SHREK';

const nameSongs = [
	"ACCIDENTALLY IN LOVE", /*1*/
	"BUTTERFLY BOUCHER", /*2*/
	"LIPPS INC - FUNKYTOWN", /*3*/
	"I NEED SOME SLEEP", /*4*/
	"HOLDING OUT FOR A HERO (JENNIFER SAUNDERS)", /*5*/
	"EVER FALLEN IN LOVE", /*6*/
	"LITTLE DROP OF POISON", /*7*/
	"JOSEPH ARTHUR - YOU'RE SO TRUE", /*8*/
	"PEOPLE AIN'T NO GOOD", /*9*/
	"FAIRY GODMOTHER SONG", /*10*/
	"LIVIN' LA VIDA LOCA", /*11*/
