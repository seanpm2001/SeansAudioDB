...
const nameSongs = [
	...
	"I DROVE ALL NIGHT", /*6*/
	"MONEY CHANGES EVERYTHING", /*7*/
	"CHANGE OF HEART", /*8*/
	"THE GOONIES 'R' GOOD ENOUGH", /*9*/
	"SALLY'S PIGEONS", /*10*/
	"WHAT'S GOING ON", /*11*/
	"HAT FULL OF STARS", /*12*/
	"WHEN YOU WERE MINE", /*13*/
	"SHINE", /*14*/
	"INTO THE NIGHTLIFE", /*15*/
	"MY FIRST NIGHT WITHOUT YOU", /*16*/
	"COME ON HOME", /*17*/
	"ABOVE THE CLOUDS", /*18*/
	"I'M GONNA BE STRONG", /*19*/
