/* =======================SET======================= */
const nameBand = "VITI RUIZ";

let nameSongs = [
	"CARICIAS PROHIBIDAS", /*1*/
	"MAGIA ROSA ", /*2*/
	"ME MUERO POR ESTAR CONTIGO", /*3*/
	"ENTRE FAMILIA", /*4*/
	"ESTA NOCHE TENGO GANAS", /*5*/
	"SOLO MIA", /*6*/
	"SEDÚCEME", /*7*/
	"SI FALTAS ME MATAS", /*8*/
	"UNA CARA BONITA", /*9*/
	"QUIERO DORMIR CANSADO", /*10*/
	"HAY HOMBRES QUE SABEN QUERER", /*11*/
	"FUE POR ESO", /*12*/
	"LLENA DE MI", /*13*/
	"FUEGO", /*14*/
	"CORAZÓN LOCO", /*15*/
	"BESOS DE HIELO", /*16*/
	"NO LA DEJES VOLVER", /*17*/
	"AL OIR MI NOMBRE", /*18*/
	"GUITARRA Y LUNA", /*19*/
	"CORAZÓN LOCO", /*20*/
]
