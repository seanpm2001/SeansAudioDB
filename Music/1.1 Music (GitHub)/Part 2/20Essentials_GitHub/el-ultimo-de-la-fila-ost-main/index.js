...
const nameBand = 'EL ÚLTIMO DE LA FILA';

let nameSongs = [
	"EL LOCO DE LA CALLE", /*1*/
	"COMO UN BURRO AMARRADO EN LA PUERTA DEL BAILE", /*2*/
	"LLANTO DE PASIÓN", /*3*/
	"LA PIEDRA REDONDA", /*4*/
	"AVIONES PLATEADOS", /*5*/
	"INSURRECCIÓN", /*6*/
	"NO ME ACOSTUMBRO", /*7*/
	"YA NO DANZO AL SON DE LOS TAMBORES", /*8*/
	"A VECES SE ENCIENDE", /*9*/
	"QUERIDA MILAGROS", /*10*/
	"SON CUATRO DÍAS", /*11*/
	"¿QUIÉN ERES TÚ?", /*12*/
	"DIOS DE LA LLUVIA", /*13*/
	"SARA", /*14*/
	"COMO LA CABEZA AL SOMBRERO", /*15*/
	"TRABAJO DURO", /*16*/
	"MI PATRIA EN MIS ZAPATOS", /*17*/
	"INSURRECCIÓN", /*18*/
	"DULCES SUEÑOS", /*19*/
	"LEJOS DE LAS LEYES DE LOS HOMBRES", /*20*/
]
