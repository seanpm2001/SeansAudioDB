...
const nameBand = 'QUEENS OF THE STOP AGE';

let nameSongs = [
  "NO ONE KNOWS", /*1*/
  "GO WITH THE FLOW", /*2*/
  "LITTLE SISTER", /*3*/
  "THE LOST ART OF KEEPING A SECRET", /*4*/
  "MAKE IT WIT CHU", /*5*/
  "SICK, SICK, SICK", /*6*/
  "IF I HAD A TAIL", /*7*/
  "SMOOTH SAILING", /*8*/
  "I SAT BY THE OCEAN", /*9*/
  "3'S & 7'S", /*10*/
  "THE WAY YOU USED TO DO", /*11*/
    "IF ONLY", /*12*/
  "MY GOD IS THE SUN", /*13*/
  "FEEL GOOD HIT OF THE SUMMER", /*14*/
    "MEXICOLA", /*15*/
  "BURN THE WITCH", /*16*/
  "IN MY HEAD", /*17*/
  "DO IT AGAIN", /*18*/
  "KALOPSIA", /*19*/
  "A SONG FOR THE DEAD", /*20*/
  ]
