...
let nameSongs = [
	...
	"A TIENTAS", /*4*/
	"CENIZA", /*5*/
	"CUANDO LLEGUE EL FIN", /*6*/
	"ESOS OJOS NEGROS", /*7*/
	"LA CASA AZUL", /*8*/
	"LA BARRA DE ESTE HOTEL", /*9*/
	"AL CAER LA NOCHE", /*10*/
	"EL BOSQUE", /*11*/
	"NO DEBES MARCHAR", /*12*/
	"SEÑALES EN EL CIELO", /*13*/
	"PALABRAS SIN NOMBRE", /*14*/
	"ACUERDATE", /*15*/
	"LA ÚLTIMA CANCIÓN", /*16*/
	"NO DEJARÍA (DE QUERERTE)", /*17*/
	"LA LLUVIA CAE ", /*18*/
	"SI NO ERES TÚ", /*19*/
	"DIME", /*20*/
]
