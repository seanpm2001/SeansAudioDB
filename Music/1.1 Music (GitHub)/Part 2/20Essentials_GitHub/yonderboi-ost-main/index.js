...
let nameSongs = [
	...
	"INTRO", /*4*/
	"THE SEVERANCE", /*5*/
	"BADLY BROKEN BUTTERFLY", /*6*/
	"TRAINS IN THE NIGHT", /*7*/
	"ROAD MOVIE", /*8*/
	"PABADAM", /*9*/
	"BODYSURF", /*10*/
	"ANOTHER GEOMETRY", /*11*/
	"FAIRY OF THE LAKE", /*12*/
	"SUSTAIN THE UNTRUTH", /*13*/
	"SHALLOW AND PROFOUND", /*14*/
	"SERENADE", /*15*/
	"OUTRO", /*16*/
	"EVEN IF YOU ARE VICTORIOUS", /*17*/
	"BRIGHTER THAN ANYTHING", /*18*/
	"ROUGH AND RARE", /*19*/
	"MILONGA DEL MAR", /*20*/
]
