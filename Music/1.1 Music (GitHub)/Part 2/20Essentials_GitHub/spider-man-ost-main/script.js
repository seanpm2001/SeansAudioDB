/* =======================SET======================= */
const nameBand = "SPIDERMAN - OST";

let nameSongs = [
	"THE SPECTACULAR SPIDER-MAN", /*1*/
	"HERO", /*2*/
	"SUNFLOWER ", /*3*/
	"MAINT TITLES - SPIDERMAN 1", /*4*/
	"MAINT TITLES - SPIDERMAN 2", /*5*/
	"MAINT TITLES - SPIDERMAN 3", /*6*/
	"SPIDER-MAN 3 OST BLACK SUIT THEME", /*7*/
	"FAREWELL", /*8*/
	"SPIDER-MAN 90S THEME", /*9*/
	"SPIDER-MAN THEME (1967)", /*10*/
	"WHAT WE'RE ALL ABOUT - SUM 41", /*11*/
	"THE EDGE - ALLESTER REIN", /*12*/
	"SPIDEY BELLS ", /*13*/
	"SIGNAL FIRE ", /*14*/
	"VINDICATED", /*15*/
	"STOLEN", /*16*/
	"SAVE THE DAY - TRAIN", /*17*/
	"COUNTING AIRPLANES", /*18*/
	"ELEVATOR - BOXCAR RACER", /*19*/
	"ORDINARY", /*20*/
]
