...
const nameBand = 'PROJECT X';

const nameSongs = [
	"PROJECT X PURSUIT OF HAPPINESS", /*1*/
	"HEADS WILL ROLL", /*2*/
	"PRETTY GIRLS - WALE", /*3*/
	"DESPICABLE DOGS - SMALL BLACK", /*4*/
	"BLOW UP - J COLE", /*5*/
	"RAY BAN VISION - A-TRAK", /*6*/
	"BITCH BETTA HAVE MY MONEY ", /*7*/
	"SHE JUST LIKE TO FIGHT ", /*8*/
	"TROUBLE ON MY MIND", /*9*/
	"NAS - NASTY", /*10*/
	"WILD BOYS - MGK", /*11*/
	"FAR EAST MOVEMENT FT.  PITBULL", /*12*/
	"LE DISKO - SHINY TOY GUNS", /*13*/
	"WE WANT P...", /*14*/
	"AFTER DARK - TITO & TARANTULA", /*15*/
	"TIPSY", /*16*/
	"BANG ON! - HANDS HIGH", /*17*/
	"BASSNECTAR - PAGING STEREOPHONIC", /*18*/
	"SUNI CLAY - IN A HOOD NEAR YOU", /*19*/
	"LCD SOUNDSYSTEM - DAFT PUNK", /*20*/
]
