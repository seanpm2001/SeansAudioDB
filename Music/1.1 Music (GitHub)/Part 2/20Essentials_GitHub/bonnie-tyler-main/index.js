...
const nameBand = 'BONNIE TYLER';

const nameSongs = [
	"HOLDING OUT FOR A HERO", /*1*/
	"TOTAL ECLIPSE OF THE HEART", /*2*/
	"IT'S A HEARTACHE", /*3*/
	"TOTAL ECLIPSE VERSION 2", /*4*/
	"SI DEMAIN...", /*5*/
	"IF YOU WERE A WOMAN", /*6*/
	"TURN AROUND", /*7*/
	...
	"ROCKIN' GOOD WAY", /*11*/
	"THE BEST", /*12*/
	"GOD GAVE LOVE TO YOU", /*13*/
	"TOTAL ECLIPSE NIGHTCORE", /*14*/
	"HERE SHE COMES", /*15*/
	"IF YOU WERE A WOMAN", /*16*/
	"AGAINST THE WIND", /*17*/
	"TAKE ME BACK", /*18*/
	"FASTER THAN THE SPEED OF NIGHT", /*19*/
	"FOOLS LULLABY", /*20*/
]
