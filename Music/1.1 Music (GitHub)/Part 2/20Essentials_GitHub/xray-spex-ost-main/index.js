...
const nameBand = 'X-RAY SPEX';

let nameSongs = [
	"OH BONDAGE UP YOURS!", /*1*/
	"I'M A POSEUR", /*2*/
	"PLASTIC BAG", /*3*/
	"THE DAY THE WORLD TURNED DAY-GLO", /*4*/
	"I AM A CLICHE", /*5*/
	"LET'S SUBMERGE", /*6*/
	"ART-I-FICIAL", /*7*/
	"WARRIOR IN WOOLWORTH", /*8*/
	"I CAN'T DO ANYTHING", /*9*/
	"OBSSESSED WITH YOU", /*10*/
	"IDENTITY", /*11*/
	"GERM FREE ADOLESCENTS", /*12*/
	" GENETIC ENGINEERING", /*13*/
	"HIGHLY INFLAMMABLE", /*14*/
	"AGE", /*15*/
	"CRYSTAL CLEAR", /*16*/
	"MELANCHOLY", /*17*/
	"CIGARETTES", /*18*/
