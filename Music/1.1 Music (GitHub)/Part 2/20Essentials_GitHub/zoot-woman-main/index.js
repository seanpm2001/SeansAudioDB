...
const nameBand = 'ZOOT WOMAN';

let nameSongs = [
	"GREY DAY", /*1*/
	"IT'S AUTOMATIC", /*2*/
	"LIVING IN A MAGAZINE", /*3*/
	"INFORMATION FIRST", /*4*/
	"GEM", /*5*/
	"TAKEN IT ALL", /*6*/
	"DON’T TEAR YOURSELF", /*7*/
	"HOPE IN THE MIRROR", /*8*/
	"BLIND", /*9*/
	"MEMORY", /*10*/
	"LIVE AND LEARN", /*11*/
	"WE WON'T BREAK", /*12*/
	"MAYBE SAY", /*13*/
	"ANOTHER TIME LIKE NOW", /*14*/
	"DRIVER, PASSENGER", /*15*/
	"LONELY, BY YOUR SIDE", /*16*/
	"MORE THAN EVER", /*17*/
	"JUST A FRIEND OF MINE", /*18*/
	"WITNESS", /*19*/
	"SOLID GOLD", /*20*/
]
