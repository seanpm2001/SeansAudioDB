...
const nameBand = 'YARDBIRDS';

let nameSongs = [
	"FOR YOUR LOVE", /*1*/
	"I'M A MAN", /*2*/
	" SHAPES OF THINGS", /*3*/
	"I AIN'T DONE WRONG ", /*4*/
	"HEART FULL OF SOUL", /*5*/
	"OVER UNDER SIDEWAYS DOWN", /*6*/
	"EVIL HEARTED YOU", /*7*/
	"HAPPENINGS TEN YEARS TIME AGO", /*8*/
	"TRAIN KEPT A-ROLLIN'", /*9*/
	"STILL I'M SAD", /*10*/
	"THE NAZ", /*11*/
	"DRINKING MOLE", /*12*/
	"NEW YORK CITY BLUES", /*13*/
	"WHITE SUMMER", /*14*/
	"SMILE ON ME", /*15*/
	"THE SUN IS SHINING", /*16*/
	"I'M NOT TALKING", /*17*/
	"MR. ZERO", /*18*/
	"HOT HOUSE OF OMAR", /*19*/
	"HA HA SAID THE CLOWN", /*20*/
]
