...
let nameSongs = [
	...
	"UNBREAKABLE", /*12*/
	"WHERE YOU ARE", /*13*/
	"FEARLESS PART 1 & PART 2", /*14*/
	"DREAMS + VISION", /*15*/
	"VISION X WHERE WE STARTED", /*16*/
	"VISION x WITHOUT ME", /*17*/
	"DARKNESS X LOST", /*18*/
	"FEARLESS ( INSTRUMENTAL )", /*19*/
	"FEARLESS PT.II (SLOWED DOWN)", /*20*/
]
