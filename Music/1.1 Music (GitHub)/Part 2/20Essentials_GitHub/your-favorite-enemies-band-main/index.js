...
const nameBand = 'YOUR FAVORITE ENEMIES';

let nameSongs = [
	"LITTLE SISTER", /*1*/
	"NO TIME LEFT FOR CONFUSION", /*2*/
	"WOULD YOU BELIEVE", /*3*/
	"HOLD ME", /*4*/
	"THE VOICE INSIDE", /*5*/
	"OPEN YOUR EYES", /*6*/
	"TURN THE DIRT OVER", /*7*/
	"SUNSET BLOW", /*8*/
	"THE MIGHTIEST OF GUNS", /*9*/
	"KEROSENE", /*10*/
	"A VIEW FROM WITHIN", /*11*/
	"THE MESSENGER", /*12*/
	"I JUST WANT YOU TO KNOW", /*13*/
	"WHERE DID WE LOSE EACH OTHER", /*14*/
	"MUETS AUX TEMPS DES AMOURS", /*15*/
	"1-2-3 (ONE STEP AWAY)", /*16*/
	"FROM THE CITY TO THE OCEAN", /*17*/
	"UNDERNEATH A STRETCHING SKYLINE", /*18*/
	"EMPIRE OF SORROWS", /*19*/
	"OBSESSION IS A GUN", /*20*/
]
