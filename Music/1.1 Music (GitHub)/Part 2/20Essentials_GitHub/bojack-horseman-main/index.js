...
const nameBand = 'BOJACK HORSEMAN';

const nameSongs = [
	"THEME", /*1*/
	"LOS AGELESS", /*2*/
	"BACK IN THE 90'S", /*3*/
	"MR. PEANUTBUTTER'S HOUSE THEME", /*4*/
	"MR. BLUE", /*5*/
	"A HORSE WITH NO NAME", /*6*/
	"DON'T STOP DANCING", /*7*/
	"I WILL ALWAYS THINK OF YOU", /*8*/
	"STARS", /*9*/
	"SEA OF DREAMS", /*10*/
	"TAKE ME DOWN EASY", /*11*/
	"HALLWAY", /*12*/
	"SEAPORT", /*13*/
	"CHASING KELSEY", /*14*/
	"BABY SEAHORSE AND CONVENIENCE STORE", /*15*/
	"FACTORY", /*16*/
	"DARKNESS AND TUNNEL", /*17*/
	"FLYING", /*18*/
	"HORSIN' AROUND THEME", /*19*/
	"GET DAT FETUS KILL DAT FETUS", /*20*/
]
