/* =======================SET======================= */
const nameBand = "2 RAFF & 2-4 FAMILY";

let nameSongs = [
	"DON'T STOP THE MUSIC", /*1*/
	"TAKE ME HOME", /*2*/
	"DON'T STOP THE MUSIC (RADIO CUT)", /*3*/
	"STAY", /*4*/
	"DON'T STOP THE MUSIC (ON MIX)", /*5*/
	"LEAN ON ME", /*6*/
	" DON'T STOP THE MUSIC (JAMAICAN MIX)", /*7*/
	"BRAND NEW TOY", /*8*/
	"DON'T STOP THE MUSIC (RAGGA 12 MIX)", /*9*/
	"9 LIVES", /*10*/
	"DON'T STOP THE MUSIC (LINGO 12 MIX)", /*11*/
	"JUMP", /*12*/
	"EVERY TIME YOU GO AWAY ", /*13*/
	"STAND UP!", /*14*/
	"FLAME", /*15*/
	"SO UNIQUE", /*16*/
	"WHO KNOWS WHAT U'LL FIND", /*17*/
	"9 LIVES (REAL-MIX)", /*18*/
	"STAY (SPECIAL RADIO VERSION)", /*19*/
	"TAKE ME HOME (RADIO VERSION)", /*20*/
]
