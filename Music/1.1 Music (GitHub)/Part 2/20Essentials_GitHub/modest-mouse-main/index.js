...
const nameBand = 'MODEST MOUSE';

let nameSongs = [
	"FLOAT ON", /*1*/
	"DASHBOARD", /*2*/
	"OCEAN BREATHE SALTY", /*3*/
	"THE WORLD AT LARGE", /*4*/
	"LAMPSHADES ON FIRE", /*5*/
	"MISS THE BOAT", /*6*/
	"SATELLITE SKIN", /*7*/
	"PAPER THIN WALLS", /*8*/
	"THIRD PLANET", /*9*/
	"GRAVITY RIDES EVERYTHING", /*10*/
	"FIRE IT UP", /*11*/
	"BLACK CADILLACS", /*12*/
	"OUT OF GAS", /*13*/
	"KING RAT", /*14*/
	"COWBOY DAN", /*15*/
	"LIVES", /*16*/
	"DARK CENTER OF THE UNIVERSE", /*17*/
	"TRAILER TRASH", /*18*/
	"TALKING SHIT ABOUT A PRETTY SUNSET", /*19*/
	"WE'VE GOT EVERYTHING", /*20*/
]
