...
const nameBand = 'ELTON JOHN';

let nameSongs = [
	"I’M STIL STANDING", /*1*/
	"ROCKET MAN", /*2*/
	"TINY DANCERTINY DANCER", /*3*/
	"YOUR SONG", /*4*/
	"CANDLE IN THE WIND", /*5*/
	"GOODBYE YELLOW BRICK ROAD", /*6*/
	"CROCODILE ROCK", /*7*/
	"DON'T GO BREAKING MY HEART", /*8*/
	"DON'T LET THE SUN GO DOWN ON ME", /*9*/
	"BENNIE AND THE JETS", /*10*/
	"I GUESS THAT'S WHY THEY CALL IT THE BLUES", /*11*/
	"SAD SONGS SAY SO MUCH", /*12*/
	"SACRIFICE", /*13*/
	"NIKITA", /*14*/
	"SATURDAY NIGHT'S ALRIGHT FOR FIGHTING", /*15*/
	"DANIEL", /*16*/
	"PHILADELPHIA FREEDOM", /*17*/
	"SOMEONE SAVED MY LIFE TONIGHT", /*18*/
	"SORRY SEEMS TO BE THE HARDEST WORD", /*19*/
	"CAN YOU FEEL THE LOVE TONIGHT", /*20*/
]
