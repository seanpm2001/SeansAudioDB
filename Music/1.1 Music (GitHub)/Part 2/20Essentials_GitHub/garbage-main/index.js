...
const nameBand = 'GARBAGE';

let nameSongs = [
	"STUPID GIRL", /*1*/
	"I THINK I'M PARANOID", /*2*/
	"PUSH IT", /*3*/
	"QUEER", /*4*/
	"CHERRY LIPS (GO BABY GO!)", /*5*/
	"WHY DO YOU LOVE ME", /*6*/
	"RUN BABY RUN", /*7*/
	"VOW", /*8*/
	"ONLY HAPPY WHEN IT RAINS", /*9*/
	"BLEED LIKE ME", /*10*/
	"YOU LOOK SO FINE", /*11*/
	"THE TRICK IS TO KEEP BREATHING", /*12*/
	"EMPTY", /*13*/
	"NO GODS NO MASTERS", /*14*/
	"  CITIES IN DUST", /*15*/
	"NO HORSES", /*16*/
	"SPECIAL", /*17*/
	"USE ME", /*18*/
