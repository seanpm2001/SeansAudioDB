...
const nameBand = 'LINKED HORIZON';

let nameSongs = [
	"GUREN NO YUMIYA", /*1*/
	"SHINZOU WO SASAGEYO", /*2*/
	"RED SWAM (FT. YOSHIKI)", /*3*/
	"SHOUKEI TO SHIKABANE NO MICHI", /*4*/
	"JIYUU NO TSUBASA", /*5*/
	"GUREN NO ZAHYOU", /*6*/
	"KAKUMEI NO YOKAN", /*7*/
	" JIYUU E NO SHINGEKI", /*8*/
	"DOA TO HIKARI / 双翼のヒカリ", /*9*/
	"自由の代償", /*10*/
	"彼女は冷たい棺の中で", /*11*/
	"彼の者の名は…", /*12*/
	"希望へ向う譚詩曲", /*13*/
	...
	"花が散る世界", /*16*/
	"雛鳥", /*17*/
	"THEME OF THE LINKED HORIZON", /*18*/
	"ルクセンダルク紀行", /*19*/
	"戦いの鐘 (LONG VERSION)", /*20*/
]
