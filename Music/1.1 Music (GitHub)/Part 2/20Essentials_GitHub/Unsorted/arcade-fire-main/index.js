...
const nameBand = 'ARCADE FIRE';

const nameSongs = [
	"PINK ELEPHANT", /*1*/
	"AGE OF ANXIETY", /*2*/
	"END OF THE EMPIRE I-III", /*3*/
	"THE LIGHTNING I, II ", /*4*/
	"UNCONDITIONAL I (LOOKOUT KID)", /*5*/
	"WE", /*6*/
	"EVERYTHING NOW", /*7*/
	"SIGNS OF LIFE", /*8*/
	"CREATURE COMFORT", /*9*/
	"AGE OF ANXIETY II (RABBIT HOLE) ", /*10*/
	"END OF THE EMPIRE IV", /*11*/
	"PETER PAN", /*12*/
	"CHEMISTRY", /*13*/
	"INFINITE CONTENT", /*14*/
	"ELECTRIC BLUE", /*15*/
	"GOOD GOD DAMN", /*16*/
	"PUT YOUR MONEY ON ME", /*17*/
	"WE DON'T DESERVE LOVE", /*18*/
	"EVERYTHING NOW", /*19*/
	"FLASHBULB EYES", /*20*/
]
