...
const nameBand = 'MANU GUIX';

const nameSongs = [
	"SE SENT SOLO", /*1*/
	"COM DUES GOTES D'AIGUA", /*2*/
	"EL GOT MIG PLE", /*3*/
	"EN TRES MINUTS", /*4*/
	"MOMENTS", /*5*/
	"SEGUIREM", /*6*/
	...
	"NO EM QUEDA CLAR", /*10*/
	"UNA PARAULA", /*11*/
	"DÓNA-LI A LA VIDA", /*12*/
	"GARGANTA CON ARENA", /*13*/
	"VIATGEM PEL MÓN", /*14*/
	"NO ENS CAL RES MÉS", /*15*/
	"CRIDO", /*16*/
	"TRESOR AMAGAT", /*17*/
	"VINE AMB MI", /*18*/
	"A CAVALL DEL VENT", /*19*/
	"SUEÑOS DE UN LUNÁTICO", /*20*/
]
