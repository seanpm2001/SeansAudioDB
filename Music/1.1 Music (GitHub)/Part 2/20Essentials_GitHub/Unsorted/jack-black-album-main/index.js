...
let nameSongs = [
	...
	"LOVE LIFTED ME", /*6*/
	"RAPPIN' POLKA", /*7*/
	"CLARINETTER'S POLK", /*8*/
	"COSMIC I", /*9*/
	"CHAD GADYA", /*10*/
	"OH HANUKKAH", /*11*/
	"WE ALL WEAR CLOAKS", /*12*/
	"BEAUTIFUL DREAMER", /*13*/
	"TO BE AN AMERICAN", /*14*/
	"SEVENTY-SIX TROMBONES", /*15*/
	"SCHOOL OF ROCK", /*16*/
	"HEAL ME, I'M HEARTSICK", /*17*/
	"T.V. EYE", /*18*/
	"IT'S A LONG WAY TO THE TOP", /*19*/
	"FIGHT", /*20*/
]
