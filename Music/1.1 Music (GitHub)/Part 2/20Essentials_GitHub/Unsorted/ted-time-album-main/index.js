...
const nameSongs = [
	...
	"WINGS OF FIRE ZEN", /*3*/
	"LABYRINTH OF HELL", /*4*/
	"ECHOES OF EMPTINESS", /*5*/
	"PARADOX OF PERFECTION", /*6*/
	"REFLECTIONS", /*7*/
	"FRACTURED TRUTHS", /*8*/
	"THE ILLUSION", /*9*/
	"DREAMING EYE THE MOON", /*10*/
	"BLISS DEALER", /*11*/
	"WAVES OF ME", /*12*/
	"THE ALCHEMY OF MADNESS", /*13*/
	"INFINITE DOORS", /*14*/
	"THE BURNING EYE", /*15*/
	"VAMPIRE HEART POP", /*16*/
	"WASTED ON THE EDGE", /*17*/
	"TOXIC HIGH", /*18*/
	"WASTED SOULS", /*19*/
	"SINISTER 666", /*20*/
]
