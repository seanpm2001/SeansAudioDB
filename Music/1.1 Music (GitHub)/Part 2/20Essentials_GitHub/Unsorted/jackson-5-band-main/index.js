...
let nameSongs = [
	...
	"SUGAR DADDY", /*9*/
	"REACH IN", /*10*/
	"THE LOVE I SAW IN YOU WAS JUST A MIRAGE", /*11*/
	"HOW FUNKY IS YOUR CHICKEN", /*12*/
	"I’LL BET YOU", /*13*/
	"DON’T KNOW WHAT I LOVE YOU", /*14*/
	"2-4-6-8", /*15*/
	" I’M THE ONE YOU NEED", /*16*/
	"ONE MORE CHANCE", /*17*/
	" I FOUND THAT GIRL", /*18*/
	"LOOKIN' THROUGH THE WINDOWS", /*19*/
	"THE LIFE OF THE PARTY", /*20*/
]
