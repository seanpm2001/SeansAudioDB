...
let nameSongs = [
	...
	"CONSUMPTION", /*5*/
	"ME SO STUPID", /*6*/
	" GIMME ALL YOUR LOVIN'", /*7*/
	"GOT ME UNDER PRESSURE", /*8*/
	"BLUE JEAN BLUES", /*9*/
	"I'M BAD, I'M NATIONWIDE", /*10*/
	"LEGS", /*11*/
	"JESUS JUST LEFT CHICAGO", /*12*/
	"WAITIN' FOR THE BUS", /*13*/
	"HEARD IT ON THE X", /*14*/
	"CHEAP SUNGLASSES", /*15*/
	"SLEEPING BAG", /*16*/
	"PEARL NECKLACE", /*17*/
	"TV DINNERS", /*18*/
	"FOOL FOR YOUR STOCKINGS", /*19*/
	"I THANK YOU", /*20*/
]
