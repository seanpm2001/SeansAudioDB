...
const nameSongs = [
	...
	"1996 ", /*6*/
	"TECHNO FAN", /*7*/
	"YOUR BODY IS A WEAPON", /*8*/
	"LET'S DANCE TO JOY DIVISION", /*9*/
	"MOVING TO NEW YORK", /*10*/
	"LEMON TO A KNIFE FIGHT", /*11*/
	"FIRST KISS", /*12*/
	"OUR PERFECT DISEASE", /*13*/
	"ANTI-D", /*14*/
	"EMOTICONS", /*15*/
	"KILL THE DIRECTOR", /*16*/
	"CHEETAH TONGUE", /*17*/
	"BE YOUR SHADOW", /*18*/
	"IF YOU EVER LEAVE", /*19*/
	"BACKFIRE", /*20*/
]
