...
const nameBand = 'ZORKEN ';

const nameSongs = [
	"GODMODE X LUCHA - I'M A MONSTER", /*1*/
	"PRISMO - STRONGER", /*2*/
	"BADDER THAN THE BAD BOYS", /*3*/
	"I WANT IT - 3 ONE OH", /*4*/
	"CADMIUM - NO FRIENDS", /*5*/
	"LOST SKY - FEARLESS PT.II", /*6*/
	"MAESTRO CHIVES - ROYALTY", /*7*/
	"UNKNOWN BRAIN - SUPERHERO", /*8*/
	"HIGHSOCIETY - NEW DRUG", /*9*/
	"NEFFEX - SECRETS", /*10*/
	"BEA MILLER - PLAYGROUND", /*11*/
	"NEFFEX - GO!", /*12*/
	"QUINTA - TOUCH ME", /*13*/
	"BENTEZ - GOOD MANNERS", /*14*/
	"SCOTT THE PISCES - I WANNA KNOW", /*15*/
	"DESREN & FYSL - LEMONADE", /*16*/
	"STILL HERE - LOL", /*17*/
	"VOILÀ - FIGURE YOU OUT", /*18*/
	"NEFFEX - PURPOSE", /*19*/
	"CADMIUM - BE WITH YOU", /*20*/
]
