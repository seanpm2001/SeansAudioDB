...
const nameBand = 'BELLE AND SEBASTIAN';

const nameSongs = [
	"THE PARTY LINE", /*1*/
	"JULIET NAKED", /*2*/
	"GIVE A LITTLE TIME", /*3*/
	"WHEN WE WERE VERY YOUNG", /*4*/
	"WILL I TELL YOU A SECRET", /*5*/
	"SO IN THE MOMENT", /*6*/
	"THE EVENING STAR", /*7*/
	"WHEN YOU’RE NOT WITH ME", /*8*/
	"I DON'T KNOW WHAT YOU SEE IN ME", /*9*/
	"DO YOU FOLLOW", /*10*/
	"WHEN THE CYNICS STARE", /*11*/
	"LATE DEVELOPERS", /*12*/
	"YOUNG AND STUPID", /*13*/
	"IF THEY'RE SHOOTING AT YOU", /*14*/
	"TALK TO ME, TALK TO ME", /*15*/
	"RECLAIM THE NIGHT", /*16*/
	"DO IT FOR YOUR COUNTRY", /*17*/
	"PROPHETS ON HOLD", /*18*/
	"COME ON HOME", /*19*/
