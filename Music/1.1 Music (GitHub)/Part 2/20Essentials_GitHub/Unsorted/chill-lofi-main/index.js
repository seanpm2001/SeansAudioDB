...
const nameBand = 'CHILL LOFI';

const nameSongs = [
	"JAM - OSOKU", /*1*/
	"CITYSCAPE  - GUUSTAVV", /*2*/
	"FIRST SIP OF COFFEE - JOBII", /*3*/
	"AIR CONDITIONING - GUUSTAVV", /*4*/
	"ANGELS WE HAVE HEARD - MATT LARGE", /*5*/
	"ALL THE JINGLE LADIES - JOBII", /*6*/
	"ICE TOWN - YELLOWBASE", /*7*/
	"CANDY CANE BRAIN - JUSTNORMAL", /*8*/
	"WHAT A NIGHT - JUSTNORMAL", /*9*/
	"STOCKING STUFFER - GUUSTAVV", /*10*/
	"SNOWGLOBES - SMARTFACE", /*11*/
	"XMAS WITH ME - DYLAN SITTS ", /*12*/
	"REINDEER SWEATER - FROOK", /*13*/
	"WINTER WALK - SMARTFACE", /*14*/
	"TO THE MISTLETOE - DYLAN SITTS", /*15*/
	"AULD LANG SYNE - JOBII", /*16*/
	"JOY TO THE WORLD  - TIMOTHY INFINITE", /*17*/
	"O HOLY NIGHT - DUSTY DECKS", /*18*/
	"JINGLE JAWN - DYLAN SITTS", /*19*/
	"THE FIRST NOEL  - MATT LARGE", /*20*/
]
