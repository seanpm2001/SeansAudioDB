...
const nameSongs = [
	...
	"WILD WORLD", /*3*/
	"LADY D'ARBANVILLE", /*4*/
	"HOW CAN I TELL YOU", /*5*/
	"STOP BOMBING, CEASE FIRE!", /*6*/
	"WHERE DO THE CHILDREN PLAY?", /*7*/
	"TRAIN ON A HILL", /*8*/
	"KING OF A LAND", /*9*/
	"PAGAN RUN", /*10*/
	"HE IS TRUE", /*11*/
	"ALL NIGHTS, ALL DAYS", /*12*/
	"ANOTHER NIGHT IN THE RAIN", /*13*/
	"THINGS", /*14*/
	"SON OF MARY", /*15*/
	"HIGHNESS", /*16*/
	"THE BOY WHO KNEW HOW TO CLIMB WALLS", /*17*/
	"HOW GOOD IT FEELS", /*18*/
	"TAKE THE WORLD APART", /*19*/
	"ON THE ROAD TO FIND OUT", /*20*/
]
