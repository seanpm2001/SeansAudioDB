...
const nameBand = 'RAGE AGAINST THE MACHINE';

let nameSongs = [
	"KILLING IN THE NAME", /*1*/
	"SLEEP NOW IN THE FIRE", /*2*/
	"WAKE UP", /*3*/
	"BOMBTRACK", /*4*/
	"TAKE THE POWER BACK", /*5*/
	"TESTIFY", /*6*/
	"RENEGADES OF FUNK", /*7*/
	"HOW I COULD JUST KILL A MAN", /*8*/
	"PISTOL GRIP PUMP", /*9*/
	"MICROPHONE FIEND", /*10*/
	"NO SHELTER", /*11*/
	"TAKE THE POWER BACK", /*12*/
	"BORN OF A BROKEN MAN", /*13*/
	"GUERRILLA RADIO", /*14*/
	"CALM LIKE A BOMB", /*15*/
	"MIC CHECK", /*16*/
	"BORN AS GHOSTS", /*17*/
	"MARIA", /*18*/
	"VOICE OF THE VOICELESS", /*19*/
	"NEW MILLENNIUM HOMES", /*20*/
]
