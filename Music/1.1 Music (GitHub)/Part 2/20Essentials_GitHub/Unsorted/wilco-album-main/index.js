...
let nameSongs = [
	...
	"KAMERA", /*10*/
	"VIA CHICAGO", /*11*/
	"HEAVY METAL DRUMMER", /*12*/
	"FORGET THE FLOWERS", /*13*/
	"ASHES OF AMERICAN FLAGS", /*14*/
	"A SHOT IN THE ARM", /*15*/
	"MY DARLING", /*16*/
	"WE’RE JUST FRIEND", /*17*/
	"MISUNDERSTOOD", /*18*/
	"BOX FULL OF LETTERS", /*19*/
	"YOU ARE MY FACE", /*20*/
]
