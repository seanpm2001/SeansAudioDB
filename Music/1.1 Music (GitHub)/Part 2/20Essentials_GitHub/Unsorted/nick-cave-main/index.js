...
const nameBand = 'NICK CAVE & THE BAD SEEDS ';
...
const nameSongs = [
	...
	"THE WEEPING SONG", /*5*/
	"O CHILDREN", /*6*/
	"FIFTEEN FEET OF PURE WHITE SNOW", /*7*/
	"STAGGER LEE", /*8*/
	"DO YOU LOVE ME?", /*9*/
	"I NEED YOU", /*10*/
	"THE MERCY SEAT", /*11*/
	"BREATHLESS", /*12*/
	"THE SHIP SONG", /*13*/
	"MORE NEWS FROM NOWHERE", /*14*/
	"AS I SAT SADLY BY HER SIDE", /*15*/
	"LOVERMAN", /*16*/
	"TUPELO", /*17*/
	"DIG, LAZARUS, DIG!!!", /*18*/
	"NATURE BOY", /*19*/
	"THE ONE THAT I'VE BEEN WAITING FOR", /*20*/
]
