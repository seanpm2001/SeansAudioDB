...
let nameSongs = [
	...
	"FEEL THIS MOMENT ", /*4*/
	"INTERNATIONAL LOVE", /*5*/
	"FIREBALL ", /*6*/
	"SUPERSTAR - COPA AMERICA 2016", /*7*/
	"ON THE FLOOR", /*8*/
	"RAIN OVER ME", /*9*/
	"HEY BABY", /*10*/
	"DON'T STOP THE PARTY", /*11*/
	"TIME OF OUR LIVES ", /*12*/
	"BACK IN TIME", /*13*/
	"I KNOW YOU WANT ME", /*14*/
	"FREE.K", /*15*/
	"FUN", /*16*/
	"DJ GOT US FALLIN' IN LOVE", /*17*/
	"HOTEL ROOM SERVICE", /*18*/
	"CELEBRATE", /*19*/
	"BAD MAN", /*20*/
]
