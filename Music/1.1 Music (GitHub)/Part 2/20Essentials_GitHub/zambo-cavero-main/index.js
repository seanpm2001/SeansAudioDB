...
let nameSongs = [
	...
	"Y SE LLAMA PERÚ", /*5*/
	"REBECA", /*6*/
	"CADA DOMINGO A LAS 12 DESPUÉS DE LA MISA", /*7*/
	"NUESTRO SECRETO", /*8*/
	"SIGUE TU RUMBO", /*9*/
	"TU PERDICIÓN", /*10*/
	"SINCERA CONFESIÓN", /*11*/
	"OLGA", /*12*/
	"LA NOCHE DE TU AUSENCIA", /*13*/
	"EL ALCATRAZ", /*14*/
	"LA COMADRE COCOLICHE", /*15*/
	"MIS CENIZAS", /*16*/
	"DIME LA VERDAD", /*17*/
	"EL TIEMPO QUE TE QUEDE LIBRE", /*18*/
	"TE SIGO", /*19*/
	"ÉSTA ES MI TIERRA", /*20*/
]
