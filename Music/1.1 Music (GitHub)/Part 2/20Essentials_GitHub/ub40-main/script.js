...
let nameSongs = [
	...
	"CHERRY OH BABY", /*6*/
	"HOMELY GIRL", /*7*/
	"PLEASE DON'T MAKE ME CRY", /*8*/
	"FOOD FOR THOUGHT", /*9*/
	"HIGHER GROUND", /*10*/
	"GROOVIN'", /*11*/
	"WEAR YOU TO THE BALL", /*12*/
	"MANY RIVERS TO CROSS", /*13*/
	"DON'T BREAK MY HEART", /*14*/
	"BRING ME YOUR CUP", /*15*/
	"SING OUR OWN SONG", /*16*/
	"CAN'T HELP FALLING IN LOVE (RE-RELEASE)", /*17*/
	"WHERE DID I GO WRONG", /*18*/
	"BRING ME YOUR CUP", /*19*/
	"HOMELY GIRL", /*20*/
]
