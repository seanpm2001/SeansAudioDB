...
const nameSongs = [
	...
	"SAN QUENTIN", /*11*/
	"RAGGED OLD FLAG", /*12*/
	"ONE PIECE AT A TIME", /*13*/
	"THE CHICKEN IN BLACK", /*14*/
	"RUSTY CAGE", /*15*/
	"SUNDAY MORNING COMING DOWN", /*16*/
	"BED OF ROSES", /*17*/
	"YOU NEVER KNEW MY MIND", /*18*/
	"RIDERS IN THE SKY", /*19*/
	"FOLSOM PRISON BLUES", /*20*/
]
