...
const nameBand = 'NO MERCY';

let nameSongs = [
	"WHERE DO YOU GO", /*1*/
	"PLEASE DON'T GO", /*2*/
	"DON'T MAKE ME LIVE WITHOUT YOU", /*3*/
	"MISSING", /*4*/
	"WHEN I DIE", /*5*/
	"KISS YOU ALL OVER", /*6*/
	"HELLO HOW ARE YOU", /*7*/
	...
	"FULL MOON", /*10*/
	"TU AMOR", /*11*/
	"I HAVE ALWAYS LOVED YOU", /*12*/
	"WHAT IS LOVE", /*13*/
	"WHEN I DIE (RADIO VERSION)", /*14*/
	"PART OF ME", /*15*/
	"BONITA", /*16*/
	"D'YER MAK R", /*17*/
	"MY PROMISE TO YOU", /*18*/
	"IN AND OUT", /*19*/
	"THAT'S HOW MUCH I LOVE YOU", /*20*/
]
