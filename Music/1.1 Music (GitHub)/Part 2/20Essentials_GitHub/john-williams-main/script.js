/* =======================SET======================= */
const nameBand = "JOHN WILLIAMS";

let nameSongs = [
	"DUEL OF THE FATES ", /*1*/
	"BATTLE OF THE HEROES ", /*2*/
	"ACROSS THE STARS ", /*3*/
	"JEDI TEMPLE MARCH LOOP", /*4*/
	"ANAKIN'S BETRAYAL (ORDER 66) ", /*5*/
	"HEDWIG'S THEME", /*6*/
	"SUPERMAN MAIN THEME", /*7*/
	"JURASSIC PARK MAIN THEME", /*8*/
	"SCHINDLER'S LIST THEME", /*9*/
	"E.T. THE EXTRA-TERRESTRIAL THEME", /*10*/
	"JAWS THEME", /*11*/
	"CANTINA BAND", /*12*/
	"STAR WARS MAIN THEME", /*13*/
	"DARTH VADER'S THEME", /*14*/
	"THE RAIDERS MARCH ", /*15*/
	"I'M SO SORRY", /*16*/
	"REPUBLIC CLONE ARMY", /*17*/
	"OLYMPIC FANFARE AND THEME", /*18*/
	"HOOK MAIN THEME", /*19*/
	"HOME ALONE MAIN THEME", /*20*/
]
