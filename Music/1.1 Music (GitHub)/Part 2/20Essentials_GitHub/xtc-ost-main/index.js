...
const nameSongs = [
	...
	"MAKING PLANS FOR NIGEL", /*2*/
	"DEAR GOD", /*3*/
	"MAYOR OF SIMPLETON", /*4*/
	"GENERALS AND MAJORS", /*5*/
	"THIS IS POP?", /*6*/
	"THE BALLAD OF PETER PUMPKINHEAD", /*7*/
	"STATUE OF LIBERTY", /*8*/
	"EARN ENOUGH FOR US", /*9*/
	"RESPECTABLE STREET", /*10*/
	"LIFE BEGINS AT THE HOP ", /*11*/
	"IS GOING TO HELP ME ", /*12*/
	" SCIENCE FRICTION ", /*13*/
	"GRASS ", /*14*/
	" KING FOR A DAY ", /*15*/
	"ALL YOU PRETTY GIRLS ", /*16*/
	"SHAKE YOU DONKEY UP", /*17*/
	"WAKE UP ", /*18*/
	"LOVE ON A FARMBOY'S WAGES", /*19*/
	"THAT'S REALLY SUPER, SUPERGIRL ", /*20*/
]
