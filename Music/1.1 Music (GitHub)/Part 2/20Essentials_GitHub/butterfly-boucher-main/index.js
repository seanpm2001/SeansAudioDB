...
const nameBand = "BUTTERFLY BOUCHER";

let nameSongs = [
	"CHANGES", /*1*/
	"LIFE IS SHORT", /*2*/
	"NEVER LEAVE YOUR HEART ALONE", /*3*/
	"A WALK OUTSIDE", /*4*/
	"A BEAUTIFUL BOOK", /*5*/
	"LOVE WILL MAKE ME STAY", /*6*/
	"TABLE FOR ONE", /*7*/
	"NONE THE WISER", /*8*/
	"SOUL BACK", /*9*/
	"I CAN'T MAKE ME", /*10*/
	"ANOTHER WHITE DASH", /*11*/
	"A BITTER SONG", /*12*/
	"SCARY FRAGILE", /*13*/
	"GUN FOR A TOUNGE", /*14*/
	"THEY SAY YOU GROW", /*15*/
	"NEVER LET IT GO", /*16*/
	"DON'T POINT, DON'T SCARE IT", /*17*/
	"CAN YOU SEE THE LIGHTS?", /*18*/
	"BUSY", /*19*/
	"DRIFT ON", /*20*/
]
