...
let nameSongs = [
	...
	"SHEENA IS A PUNK ROCKER", /*8*/
	"BABY, I LOVE YOU", /*9*/
	"DO YOU REMEMBER ROCK 'N' ROLL RADIO?", /*10*/
	"I WANNA BE SEDATED", /*11*/
	"NEEDLES AND PINS", /*12*/
	"HERE TODAY, GONE TOMORROW", /*13*/
	"ROCKAWAY BEACH", /*14*/
	"PET SEMATARY", /*15*/
	"JUDY IS A PUNK", /*16*/
	"I WANNA LIVE", /*17*/
	"TEENAGE LOBOTOMY", /*18*/
	"GIMME GIMME SHOCK TREATMENT", /*19*/
	"PINHEAD", /*20*/
]
