...
let nameSongs = [
	...
	"DOLCE VITA", /*4*/
	"LET'S GO TO SITGES", /*5*/
	"MUSIC", /*6*/
	"SUPERSONIC LOVE", /*7*/
	"BYE BYE MI AMOR (RADIO VERSION)", /*8*/
	"BAMBINA (RADIO VERSION)", /*9*/
	"PLAYBOY", /*10*/
	"YOU'VE GOT TO MOVE IT ON", /*11*/
	"FLASHLIGHT ON A DISCO NIGHT", /*12*/
	"LET ME FEEL IT !", /*13*/
	"BUONA SERA CIAO CIAO", /*14*/
	"EVIDENTE", /*15*/
	"MIA AMATA", /*16*/
	"CHE NE FARAI", /*17*/
	"PLAYING WITH LOVE", /*18*/
	"THE LEGEND OF THE PIANIST", /*19*/
	"THE BURNING BUSH", /*20*/
]
