...
let nameSongs = [
	...
	"DATE LA VUELTA", /*4*/
	"AQUI ESTOY YO", /*5*/
	"YO NO ME DOY POR VENCIDO", /*6*/
	"QUE QUIERES DE MI", /*7*/
	"IMAGINAME SIN TI", /*8*/
	"¿QUIÉN TE DIJO ESO?", /*9*/
	"QUE QUIERES DE MI", /*10*/
	"GRITAR", /*11*/
	"RESPIRA", /*12*/
	"AUNQUE ESTÉS CON ÉL", /*13*/
	"QUISIERA PODER OLVIDARME DE TI", /*14*/
	"NADA ES PARA SIEMPRE", /*15*/
	"CORAZÓN EN LA MALETA", /*16*/
	"SERÍA FÁCIL", /*17*/
	"NADA ES PARA SIEMPRE", /*18*/
	"SI TÚ QUISIERAS", /*19*/
	"REGÁLAME UN MINUTO MÁS", /*20*/
]
