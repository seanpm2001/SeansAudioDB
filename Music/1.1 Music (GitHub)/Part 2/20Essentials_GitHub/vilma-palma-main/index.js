...
let nameSongs = [
	...
	"LA PACHANGA", /*4*/
	"TE QUIERO TANTO", /*5*/
	"PERDIENDO EL TIEMPO", /*6*/
	"UN CAMINO HASTA VOS", /*7*/
	"ME VUELVO LOCO POR VOS", /*8*/
	"VERANO TRAIDOR", /*9*/
	"SIEMPRE ESTARÁS", /*10*/
	"LA NOCHE QUE YO TE VI A TI", /*11*/
	"YA VES", /*12*/
	"TE FUISTE SONRIENDO", /*13*/
	"SINDROME DE AMOR", /*14*/
	"OTRA CANCION DE AMOR", /*15*/
	"FONDO PROFUNDO ", /*16*/
	"NO SOMOS NADA", /*17*/
	"TODO LO QUE FUE", /*18*/
	"FERNET CON COCA", /*19*/
