...
const nameBand = 'DANZA INVISIBLE';

const nameSongs = [
	"SIN ALIENTO ", /*1*/
	"SABOR DE AMOR", /*2*/
	"NATURALEZA MUERTA", /*3*/
	"A ESTE LADO DE LA CARRETERA", /*4*/
	"AGUA SIN SUEÑO", /*5*/
	"SUEÑOS DE INTIMIDAD", /*6*/
	"TU VOZ", /*7*/
	"DIARIO OCULTO", /*8*/
	"DANZA Y MAGIA DEL RITMO", /*9*/
	"NO HABRÁ FIESTAS PARA MAÑANA", /*10*/
	"ESPUELAS", /*11*/
	"CATALINA", /*12*/
	"LA MUJER IDEAL", /*13*/
	"LO QUE QUEDA DEL AMOR", /*14*/
	"CLIMA RARO", /*15*/
	"POR AHI SE VA", /*16*/
	"AL AMANECER", /*17*/
	"EL ÁNGEL CAÍDO", /*18*/
