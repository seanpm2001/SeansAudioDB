...
let nameSongs = [
	...
	"BELIEVE IN ME", /*4*/
	"I BELONG TO YOU", /*5*/
	"IT AIN'T OVER 'TIL IT'S OVER", /*6*/
	"AGAIN", /*7*/
	"ARE YOU GONNA GO MY WAY", /*8*/
	"AMERICAN WOMAN", /*9*/
	"LET LOVE RULE", /*10*/
	"CAN'T GET YOU OFF MY MIND", /*11*/
	"YOU WERE IN MI HEART", /*12*/
	"LET’S GET HIGH", /*13*/
	"IF I COULD FALL IN LOVE", /*14*/
	"DANCIN' TIL DAWN", /*15*/
	"NEW YORK CITY", /*16*/
	"THE PLEASURE AND THE PAIN", /*17*/
	"STILLNESS OF HEART", /*18*/
	"HEAVEN HELP", /*19*/
	"SUGAR", /*20*/
]
