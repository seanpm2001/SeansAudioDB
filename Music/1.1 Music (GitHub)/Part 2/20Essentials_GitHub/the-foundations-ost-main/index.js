...
const nameBand = 'THE FOUNDATIONS';

let nameSongs = [
	"BUILD ME UP BUTTERCUP", /*1*/
	"BABY NOW THAT I'VE FOUND YOU", /*2*/
	"BUILD ME UP BUTTERCUP (MONO)", /*3*/
	"BACK ON MY FEET AGAIN", /*4*/
	"HARLEM SHUFFLE", /*5*/
	"TOMORROW", /*6*/
	"BUILD ME UP BUTTERCUP (STEREO)", /*7*/
	"IN THE BAD BAD OLD DAYS ", /*8*/
	"I'M GONNA BE A RICH MAN", /*9*/
	"ANY OLD TIME", /*10*/
	"IT'S ALL RIGHT", /*11*/
	"PEOPLE ARE FUNNY", /*12*/
	"I CAN TAKE OR LEAVE YOUR LOVING", /*13*/
	"THAT SAME OLD FEELING", /*14*/
	"TAKE A GIRL LIKE YOU", /*15*/
	"GIVE ME LOVE", /*16*/
	"CALL ME", /*17*/
	"LOVE IS A FIVE LETTER WORD", /*18*/
	"COME ON BACK TO ME", /*19*/
	"BORN TO LIVE, BORN TO DIE", /*20*/
]
