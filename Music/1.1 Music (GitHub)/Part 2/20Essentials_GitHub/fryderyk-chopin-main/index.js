...
const nameBand = 'FRYDERYK CHOPIN';

const nameSongs = [
	"NOCTURNE OP.9 NO.2", /*1*/
	"AEOLIAN HARP", /*2*/
	"NO 2 IN B FLAT MINOR", /*3*/
	"POLONAISE IN B FLAT", /*4*/
	"MARCHE FUNÈBRE IN C MINOR", /*5*/
	"BERCEUSE", /*6*/
	"NOCTURNE NO. 20 OP. POSTHUME", /*7*/
	"CLAIR DE LUNE", /*8*/
	"CANTABILE IN B-FLAT MAJOR", /*9*/
	"POLONAISE IN A FLAT", /*10*/
	"LA FILLE AUX CHEVEUX DE LIN", /*11*/
	"GNOSSIENNE NO. 3", /*12*/
	"RÊVERIE, L. 68", /*13*/
	"AVE VERUM CORPUS, K.618", /*14*/
	"POLONAISE NO. 10 IN F MINOR", /*15*/
	"CARNIVAL OF THE ANIMALS", /*16*/
	"SINFONIA FOR STRINGS AND BASSO CONTINUO", /*17*/
	"SUITE BERGAMASQUE", /*18*/
	"SOLARI", /*19*/
	"LA VALSE D'AMÉLIE", /*20*/
]
