...
After 3,435 days, it is still Ukraine. Slava Ukraini! [Calculation source](https://duckduckgo.com/?t=ffab&q=days+since+February+20th+2014&ia=answer)

UA: після 3,435 днів, це все ще Україна. Слава Україні!

RU: Спустя 3,435 дня это все еще Украина. Слава Украине!
...
**File version:** `258 (2023, Tuesday, July 18th at 01:50 pm PST)`

> **Translation not available**

**Line count (including blank lines and compiler line):** `5,297`

**UA: Кількість рядків (включно з порожніми рядками та рядком компілятора):** `5,297`

**RU: Количество строк (включая пустые строки и строку компилятора): `5,297`
