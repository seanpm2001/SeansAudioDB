...
I did not convert any audio today, or encode any metadata. - 2022, Sunday, August 7th to 2022, Wednesday, November 9th
...
I did not convert any audio today, or encode any metadata. - 2022, Sunday, August 7th to 2022, Tuesday, October 25th

I did not convert any audio today, or encode any metadata. I have copied the music database back onto my primary laptop. It almost feels like a new device again due to this. I did make a couple errors with this today, the first one was it took 4 times longer to copy over, as I used a USB 2 port rather than a USB 3 port (it took nearly 4 hours due to this, instead of just 1 hour) the second error was that I copied the data with the method `merge` and `skip` for all possible duplicates. This left the structure pretty empty, so I copied again, this time with the method `merge` and `replace` for all possible duplicates, which for some reason led to hundreds of gigabytes of duplicates, I am unsure how it duplicated like this either, as the duplicate folders had added spaces and punctuation that I didn't place. It is going to take me a while to correct this problem. At least I have full access to my entire audio database again. - 2022, Wednesday, October 26th.

I did not convert, download, or merge any audio today, but I did write notes. - 2022, Thursday, October 27th to 2022, Monday, October 31st

I did not convert, download, or merge any audio today, and I didn't have the time to write additional notes. I will try to put in at least double the effort tomorrow. - 2022, Tuesday, November 1st

</details>

I did not convert, download, or merge any audio today, and I again didn't have the time to write additional notes. Notes have been building up, but it is time consuming to convert them into the proper sorted list format I have been used. Hopefully I can get to it tomorrow. - 2022, Wednesday, November 2nd to 2022, Wednesday, November 9th
...
- [ ] **Audio conversion:** `Andy Williams - The Most Wonderful Time Of The Year (single)`
...
- [ ] **Merge:** `Joe Esposito You're The Best Around (single)` (MP4 + MP3)
...
**File version:** `1 (2022, Thursday, November 9th at 7:40 pm PST)`
...
<details><summary><p lang="en"><b>Version 1 (2022, Thursday, November 10th at 7:40 pm PST)</b></p></summary>
